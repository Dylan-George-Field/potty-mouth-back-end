...
{
    // See https://msdn.microsoft.com/en-us/library/system.security.cryptography.aes(v=vs.110).aspx
    public class AES
    {
        ...
        public static string DecryptStringFromBytes_Aes(byte[] cipherText, byte[] Key)
        {
            ...
            // get first 128-bit IV from ciphertext
            var Iv = cipherText.Take(16).ToArray();

            var cipher = cipherText.Skip(16).ToArray();
