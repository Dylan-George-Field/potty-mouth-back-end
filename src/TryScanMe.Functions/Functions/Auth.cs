...
namespace TryScanMe.Functions.Functions
{
    public static class AuthFunctions
    {
        ...
        public static HttpResponseMessage IsAuthenticated(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "api/IsAuthenticated")]
        ...
        public static HttpResponseMessage GetClaims(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "api/GetClaims")]
        HttpRequestMessage request,
            TraceWriter log)
        {
        ...
        public static async Task<HttpResponseMessage> GetAuthInfo(
                        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "api/GetAuthInfo")]
        HttpRequestMessage request,
            TraceWriter log)
        {
            if (Thread.CurrentPrincipal.Identity.IsAuthenticated)
            {
                var authInfo = await request.GetAuthInfoAsync(log);
        ...
        public static async Task<HttpResponseMessage> GetEmailClaim(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "api/GetEmailClaim")]
        HttpRequestMessage request,
            TraceWriter log)
        {
